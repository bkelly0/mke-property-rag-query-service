...
class QueryResponse(BaseModel):
    ...
    routing: RoutingDecision = Field("Routing decision based on user prompt")
...
class RoutingDecision(BaseModel):
    routing_type: RoutingType = Field("The best routing type determined by the user prompt")
    reasoning: str = Field("Explanation of why this route was selected. ")